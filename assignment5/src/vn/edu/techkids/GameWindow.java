...
public class GameWindow extends Frame implements Runnable {
    ...
    public GameWindow () {
        ...
        this.bombController = new BombController(new GameObject(400, 300, 50, 50), new ImageDrawer("resources/bomb.png"));
        this.giftController = new GiftController(new GameObject(300, 100, 50, 50), new ImageDrawer("resources/gift.gif"));
